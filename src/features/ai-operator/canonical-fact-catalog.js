...
export const CANONICAL_FACT_CATALOG = Object.freeze({
  ...
  'subscriber.tariff.current.name': billingMain(['service.currentTariff', 'service.current.name']),
  'subscriber.tariff.current.price': billingMain(['finance.price', 'service.current.price'], 'money'),
  'subscriber.tariff.current.speed': billingMain(['service.speed', 'service.current.speed'], 'number', { status: 'needs_verification' }),
  'subscriber.tariff.scheduledChange.observed': billingMain('service.nextTariff', 'observed'),
  'subscriber.tariff.scheduledChange.hasChange': billingMain('service.nextTariff', 'presence'),
  'subscriber.tariff.scheduledChange.nextTariff': billingMain('service.nextTariff', 'optionalText'),
  'subscriber.tariff.scheduledChange.effectivePeriod': billingMain('service.nextTariffDelay', 'optionalText'),
