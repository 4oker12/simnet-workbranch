...
assert.ok(!source.includes("meta.step"));
assert.ok(!source.includes("Шаг ${"));
...
assert.ok(source.includes("outline:3px solid #fff"));
assert.ok(source.includes("background:rgba(31,34,38,.82)"));
