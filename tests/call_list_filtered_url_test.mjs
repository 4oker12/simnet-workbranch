...
assert.equal(url.searchParams.get('filter_selector1'), 'employee_ipphone_number');
assert.equal(url.searchParams.get('employee_ipphone_number1_value'), '6047');
...
assert.equal(anotherOperator.searchParams.get('employee_ipphone_number1_value'), '6013');
