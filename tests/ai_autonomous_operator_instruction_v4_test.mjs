...
assert.equal(AUTONOMOUS_OPERATOR_INSTRUCTION_VERSION, 4, 'runtime must use canonical reasoning instruction v4');
...
console.log('ai_autonomous_operator_instruction_v4_test: PASS');
