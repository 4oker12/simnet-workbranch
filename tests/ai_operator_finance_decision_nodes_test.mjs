...
import { calculateBalanceCoverage, calculateConnectionUpfrontPayment, deriveFinanceDecisionEvidence, financeRequiredFacts, isBalanceCoverageQuestion } from '../src/features/ai-operator/finance-decision-nodes.js';
